...
<section id="contact" class="py-20 bg-gray-800/50">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-gray-300 mb-8">
            Saya selalu terbuka untuk mendiskusikan projek baru, ide game, atau sekadar bertegur sapa.
        </p>
        
        <form class="space-y-4 text-left glass-card p-8 rounded-xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-400 mb-1">Nama</label>
                    <input type="text" class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-game-accent transition">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-400 mb-1">Email</label>
                    <input type="email" class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-game-accent transition">
                </div>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-400 mb-1">Pesan</label>
                <textarea rows="4" class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-game-accent transition"></textarea>
            </div>
            <button type="button" class="w-full bg-game-accent hover:bg-indigo-600 text-white font-bold py-3 rounded-lg transition">
                Kirim Pesan
            </button>
        </form>
    </div>
